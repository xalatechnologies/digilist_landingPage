  ...
  return (
    <div className="bg-bg min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-[1140px] mx-auto px-6 pt-8 pb-12 md:pt-12 md:pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-wrap gap-3 justify-center lg:justify-start mb-8">
                <span className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg border border-border shadow-sm">
                  <Clock size={16} className="text-cyan" aria-hidden="true" />
                  <span className="text-sm font-medium text-navy">30-45 minutter</span>
                </span>
                <span className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg border border-border shadow-sm">
                  <Shield size={16} className="text-success" aria-hidden="true" />
                  <span className="text-sm font-medium text-navy">Ingen forpliktelser</span>
                </span>
                <span className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg border border-border shadow-sm">
                  <Users size={16} className="text-primary" aria-hidden="true" />
                  <span className="text-sm font-medium text-navy">Tilpasset demo</span>
                </span>
              </div>
            </div>
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/20">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="px-2 py-1 bg-success/90 rounded text-xs font-medium text-white flex items-center gap-1">
                        <PlayCircle size={12} />
                        Gratis demo
                      </div>
                    </div>
                    <p className="text-lg font-bold text-white">Se Digilist i aksjon</p>
                    <p className="text-sm text-white/80">Tilpasset din organisasjon</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {demoFeatures.map((feature, idx) => {
                  ...
                  return (
                    <div 
                      key={idx}
                      className="group p-5 rounded-xl bg-white border border-border shadow-sm hover:shadow-lg hover:border-primary/30 hover:-translate-y-1 transition-all duration-300"
                    >
                      <div className="w-12 h-12 rounded-xl bg-primary flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                ...
                <div className="space-y-4">
                  {demoAgenda.map((item, idx) => (
                    <div key={idx} className="flex items-start gap-4 group">
                      <div className="relative z-10 w-8 h-8 rounded-full bg-primary flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 transition-transform">
                        <span className="text-xs font-bold text-white">{idx + 1}</span>
                      </div>
                      <div className="flex-1 p-4 rounded-xl bg-white border border-border shadow-sm group-hover:shadow-md group-hover:border-primary/30 transition-all duration-300">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a 
                  ...
                  className="group p-5 rounded-xl bg-white border border-border shadow-sm hover:shadow-lg hover:border-primary/30 transition-all duration-300 text-center"
                >
                  <div className="w-12 h-12 rounded-xl bg-primary flex items-center justify-center mx-auto mb-3 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                ...
                <a 
                  ...
                  className="group p-5 rounded-xl bg-white border border-border shadow-sm hover:shadow-lg hover:border-primary/30 transition-all duration-300 text-center"
                >
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan to-success flex items-center justify-center mx-auto mb-3 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                ...
                <div className="group p-5 rounded-xl bg-white border border-border shadow-sm text-center">
          ...
          <div className="lg:col-span-5 order-1 lg:order-2">
            <div className="lg:sticky lg:top-24">
              <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-border relative overflow-hidden">
                {/* Decorative corner accent */}
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-primary/10 to-cyan/10 rounded-bl-[100px]" />
